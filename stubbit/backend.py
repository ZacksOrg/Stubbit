...
class Backend:
    ...
    def CreateTestUsers():
        newUser1 = UserFile(Username="BobFitz", FirstName="Bob", LastName="Fitzgerald", Email="bob_fitzgerald@gmail.com", OrganizationID=Organization.objects.get(OrganizationName="Nova Electronics"), Department="Manufacturing", Administrator=True)
        newUser2 = UserFile(Username="JasonM", FirstName="Jason", LastName="Miller", Email="jason_miller@gmail.com", OrganizationID=Organization.objects.get(OrganizationName="Nova Electronics"), Department="Accounting", Administrator=True)
        newUser3 = UserFile(Username="Arthur_T", FirstName="Arthur", LastName="Thompson", Email="arthur_thompson@gmail.com", OrganizationID=Organization.objects.get(OrganizationName="Aristo Industries"), Department="Human Resource", Administrator=True)
        newUser4 = UserFile(Username="KellyNichols", FirstName="Kelly", LastName="Nichols", Email="kelly_nichols@gmail.com", OrganizationID=Organization.objects.get(OrganizationName="Tanaka Manufacturing"), Department="Marketing", Administrator=True)
        newUser5 = UserFile(Username="BrettNes", FirstName="Brett", LastName="Nesbitt", Email="brett_nesbitt@gmail.com", OrganizationID=Organization.objects.get(OrganizationName="Tanaka Manufacturing"), Department="Production", Administrator=True)
        newUser1.save()
        newUser2.save()
        newUser3.save()
        newUser4.save()
    ...
    def CreateTestUserPasses():
        ...
        newUserPass4 = UserPass(UserFileID=UserFile.objects.get(Username="TestUser2"), EncryptedPassword="9s0ausdf0a2hk", EncrpytionMethod="AES-ECB-128", EncryptionKey="1111111111111111")
        newUserPass5 = UserPass(UserFileID=UserFile.objects.get(Username="TestUser2"), EncryptedPassword="9sg93jf83ncm2c", EncrpytionMethod="AES-ECB-128", EncryptionKey="1111111111111111")
        newUserPass1.save()
        newUserPass2.save()
        newUserPass3.save()
        newUserPass4.save()
    ...
    def CreateTestStubs():
        ...
        newStub3 = Stub(Title="Spare Parts By Product Line", Overview="Need this ASAP for management.", Category="Request", Urgency="Highly Important", Domain="Accounting", IssuerUserFileID=UserFile.objects.get(Username="JasonM"), RecipientUserFileID=UserFile.objects.get(Username="BobFitz"), StartDate=timezone.now(), EstimatedCompletionTime="2", EstimatedCompletionTimeUOM="Hours", PriorityInQueue=1.0, InProcess=True, Completed=False, CreationDate=timezone.now())
        newStub4 = Stub(Title="Rotary Girder Specs", Overview="Check the endline specs on the rotary girder.", Category="Request", Urgency="When You Have Time", Domain="Mechanical Engineering", IssuerUserFileID=UserFile.objects.get(Username="JasonM"), RecipientUserFileID=UserFile.objects.get(Username="BobFitz"), StartDate=timezone.now(), EstimatedCompletionTime="5", EstimatedCompletionTimeUOM="Minutes", PriorityInQueue=1.0, InProcess=False, Completed=False, CreationDate=timezone.now())
        newStub5 = Stub(Title="Parts Order", Overview="Need to order more parts from supplier.", Category="Request", Urgency="Highly Important", Domain="Supplier", IssuerUserFileID=UserFile.objects.get(Username="BobFitz"), RecipientUserFileID=UserFile.objects.get(Username="JasonM"), StartDate=timezone.now(), EstimatedCompletionTime="10", EstimatedCompletionTimeUOM="Minutes", PriorityInQueue=3.0, InProcess=False, Completed=False, CreationDate=timezone.now())
        ...
        newStub7 = Stub(Title="Missing URL Paths", Overview="Some web pages are missing their URL paths.", Category="Request", Urgency="Important", Domain="Development", IssuerUserFileID=UserFile.objects.get(Username="BobFitz"), RecipientUserFileID=UserFile.objects.get(Username="BobFitz"), StartDate=timezone.now(), EstimatedCompletionTime="20", EstimatedCompletionTimeUOM="Minutes", PriorityInQueue=2.0, InProcess=False, Completed=False, CreationDate=timezone.now())
        newStub8 = Stub(Title="Form Issue", Overview="Request for parts form displaying incorrectly", Category="Bug", Urgency="Important", Domain="Development", IssuerUserFileID=UserFile.objects.get(Username="JasonM"), RecipientUserFileID=UserFile.objects.get(Username="BobFitz"), StartDate=timezone.now(), EstimatedCompletionTime="10", EstimatedCompletionTimeUOM="Minutes", PriorityInQueue=1.0, InProcess=False, Completed=False, CreationDate=timezone.now())
        newStub9 = Stub(Title="Product Line Failure", Overview="Line production has been halted from a failure.", Category="System Failure", Urgency="Immediate", Domain="Production", IssuerUserFileID=UserFile.objects.get(Username="JasonM"), RecipientUserFileID=UserFile.objects.get(Username="BobFitz"), StartDate=timezone.now(), EstimatedCompletionTime="35", EstimatedCompletionTimeUOM="Minutes", PriorityInQueue=3.0, InProcess=False, Completed=False, CreationDate=timezone.now())
        ...
        newStub11 = Stub(Title="Special Part Pickup", Overview="Need to get a specific part from the supplier.", Category="Request", Urgency="Important", Domain="Supplier", IssuerUserFileID=UserFile.objects.get(Username="BobFitz"), RecipientUserFileID=UserFile.objects.get(Username="JasonM"), StartDate=timezone.now(), EstimatedCompletionTime="30", EstimatedCompletionTimeUOM="Minutes", PriorityInQueue=1.0, InProcess=False, Completed=False, CreationDate=timezone.now())
        ...
        newStub14 = Stub(Title="Network Connection", Overview="Users keep disconnecting from wifi.", Category="Request", Urgency="Highly Important", Domain="IT", IssuerUserFileID=UserFile.objects.get(Username="JasonM"), RecipientUserFileID=UserFile.objects.get(Username="BobFitz"), StartDate=timezone.now(), EstimatedCompletionTime="2", EstimatedCompletionTimeUOM="Hours", PriorityInQueue=1.0, InProcess=False, Completed=False, CreationDate=timezone.now())
        ...
        newStub18 = Stub(Title="Stub Attachments", Overview="Stub attachments are not saving the uploaded content.", Category="Request", Urgency="Highly Important", Domain="Development", IssuerUserFileID=UserFile.objects.get(Username="JasonM"), RecipientUserFileID=UserFile.objects.get(Username="BobFitz"), StartDate=timezone.now(), EstimatedCompletionTime="2", EstimatedCompletionTimeUOM="Hours", PriorityInQueue=1.0, InProcess=False, Completed=False, CreationDate=timezone.now())
        ...
        newStub24 = Stub(Title="Peripheral Order", Overview="Need to order more peripherals for employees.", Category="Request", Urgency="Important", Domain="IT", IssuerUserFileID=UserFile.objects.get(Username="JasonM"), RecipientUserFileID=UserFile.objects.get(Username="BobFitz"), StartDate=timezone.now(), EstimatedCompletionTime="2", EstimatedCompletionTimeUOM="Hours", PriorityInQueue=1.0, InProcess=False, Completed=False, CreationDate=timezone.now())
        newStub25 = Stub(Title="Company Quarterly Review", Overview="Need report on company quarterly earnings.", Category="Request", Urgency="Important", Domain="Accounting", IssuerUserFileID=UserFile.objects.get(Username="JasonM"), RecipientUserFileID=UserFile.objects.get(Username="BobFitz"), StartDate=timezone.now(), EstimatedCompletionTime="2", EstimatedCompletionTimeUOM="Hours", PriorityInQueue=1.0, InProcess=False, Completed=False, CreationDate=timezone.now())
        newStub26 = Stub(Title="Job Application", Overview="Review job application for potential prospect.", Category="Request", Urgency="Highly Important", Domain="Human Resource", IssuerUserFileID=UserFile.objects.get(Username="BobFitz"), RecipientUserFileID=UserFile.objects.get(Username="JasonM"), StartDate=timezone.now(), EstimatedCompletionTime="2", EstimatedCompletionTimeUOM="Hours", PriorityInQueue=1.0, InProcess=False, Completed=False, CreationDate=timezone.now())
        newStub27 = Stub(Title="Push Rod Failure", Overview="Warped push rods need replacing.", Category="Request", Urgency="Immediate", Domain="Mechanical Engineering", IssuerUserFileID=UserFile.objects.get(Username="BobFitz"), RecipientUserFileID=UserFile.objects.get(Username="JasonM"), StartDate=timezone.now(), EstimatedCompletionTime="2", EstimatedCompletionTimeUOM="Hours", PriorityInQueue=1.0, InProcess=False, Completed=False, CreationDate=timezone.now())
        newStub28 = Stub(Title="Blown Head Gasket", Overview="Replace head gasket.", Category="Request", Urgency="Important", Domain="Mechanical Engineering", IssuerUserFileID=UserFile.objects.get(Username="BobFitz"), RecipientUserFileID=UserFile.objects.get(Username="JasonM"), StartDate=timezone.now(), EstimatedCompletionTime="2", EstimatedCompletionTimeUOM="Hours", PriorityInQueue=1.0, InProcess=False, Completed=False, CreationDate=timezone.now())
...
=======
        timeSinceLastLogin = datetime.datetime.now(timezone.utc) - usermeta_obj.LastLogInDate   
>>>>>>> 3f65c5704599cdac5a614d5d6439660c6483daf9
