...
class Backend:
    ...
    def CreateTestOrganizations():
        newOrganization1 = Organization(OrganizationName="Nova Electronics",LicenseID=License.objects.get(LicenseContent="7b14a00p"), AddressCountry="USA", AddressState="MD", AddressZip=90266, AddressCity="Bethesda", AddressStreet="South Oak Rd", AddressBuildingNumber="455", PhoneNumber="+18447639233")
        newOrganization2 = Organization(OrganizationName="Aristo Industries",LicenseID=License.objects.get(LicenseContent="j54h9u20"), AddressCountry="USA", AddressState="MI", AddressZip=48127, AddressCity="Detroit", AddressStreet="West Grand Boulevard", AddressBuildingNumber="219", PhoneNumber="+13132489116")
        newOrganization3 = Organization(OrganizationName="Tanaka Manufacturing",LicenseID=License.objects.get(LicenseContent="j54h9u20"), AddressCountry="USA", AddressState="WA", AddressZip=72715, AddressCity="Seattle", AddressStreet="North Winsome St", AddressBuildingNumber="368", PhoneNumber="+12861743885")
    ...
    def CreateTestStubs():
        newStub1 = Stub(Title="Crank Shaft Fix", Overview="Fix this so we can get production rolling!", Category="System Failure", Urgency="Immediate", Domain="Mechanical Engineering", IssuerUserFileID=UserFile.objects.get(Username="BobFitz"), RecipientUserFileID=UserFile.objects.get(Username="KellyNichols"), EstimatedCompletionTime="1", EstimatedCompletionTimeUOM="Days", PriorityInQueue=1.0, InProcess=True, Completed=False, CreationDate=timezone.now())
        newStub2 = Stub(Title="Rounding Error", Overview="I'm pretty sure that .49 should round to 0 not 1. See attachment below.", Category="Bug", Urgency="When You Have Time", Domain="Database", IssuerUserFileID=UserFile.objects.get(Username="BobFitz"), RecipientUserFileID=UserFile.objects.get(Username="JasonM"), EstimatedCompletionTime="3", EstimatedCompletionTimeUOM="Days", PriorityInQueue=5.0, InProcess=False, Completed=False, CreationDate=timezone.now())
        newStub3 = Stub(Title="Spare Parts By Product Line", Overview="Need this ASAP for management.", Category="Request", Urgency="Highly Important", Domain="Accounting", IssuerUserFileID=UserFile.objects.get(Username="BrettNes"), RecipientUserFileID=UserFile.objects.get(Username="BobFitz"), EstimatedCompletionTime="2", EstimatedCompletionTimeUOM="Hours", PriorityInQueue=1.0, InProcess=True, Completed=False, CreationDate=timezone.now())
        newStub4 = Stub(Title="Rotary Girder Specification in AutoCAD", Overview="Check the endline specs on the rotary girder.", Category="Suggestion", Urgency="When You Have Time", Domain="Mechanical Engineering", IssuerUserFileID=UserFile.objects.get(Username="JasonM"), RecipientUserFileID=UserFile.objects.get(Username="BobFitz"), EstimatedCompletionTime="5", EstimatedCompletionTimeUOM="Minutes", PriorityInQueue=1.0, InProcess=False, Completed=False, CreationDate=timezone.now())
        newStub5 = Stub(Title="Parts Order", Overview="Need to order more parts from supplier.", Category="Request", Urgency="Highly Important", Domain="Supplier", IssuerUserFileID=UserFile.objects.get(Username="BobFitz"), RecipientUserFileID=UserFile.objects.get(Username="BrettNes"), EstimatedCompletionTime="10", EstimatedCompletionTimeUOM="Minutes", PriorityInQueue=3.0, InProcess=False, Completed=False, CreationDate=timezone.now())
        newStub6 = Stub(Title="Employee Information Required", Overview="Need information for payroll.", Category="Request", Urgency="Highly Important", Domain="Finance", IssuerUserFileID=UserFile.objects.get(Username="JasonM"), RecipientUserFileID=UserFile.objects.get(Username="BobFitz"), EstimatedCompletionTime="30", EstimatedCompletionTimeUOM="Minutes", PriorityInQueue=4.0, InProcess=False, Completed=False, CreationDate=timezone.now())
        newStub7 = Stub(Title="Missing URL Paths", Overview="Some web pages are missing their URL paths.", Category="Bug", Urgency="Important", Domain="Development", IssuerUserFileID=UserFile.objects.get(Username="BobFitz"), RecipientUserFileID=UserFile.objects.get(Username="KellyNichols"), EstimatedCompletionTime="20", EstimatedCompletionTimeUOM="Minutes", PriorityInQueue=2.0, InProcess=False, Completed=False, CreationDate=timezone.now())
        newStub8 = Stub(Title="Project Percentage of Complete General Ledger WIP Rotation Issue", Overview="Request for parts form displaying incorrectly", Category="Bug", Urgency="Important", Domain="Development", IssuerUserFileID=UserFile.objects.get(Username="Arthur_T"), RecipientUserFileID=UserFile.objects.get(Username="BobFitz"), EstimatedCompletionTime="10", EstimatedCompletionTimeUOM="Minutes", PriorityInQueue=1.0, InProcess=False, Completed=False, CreationDate=timezone.now())
        newStub9 = Stub(Title="Product Line Failure", Overview="Line production has been halted from a failure.", Category="System Failure", Urgency="Immediate", Domain="Production", IssuerUserFileID=UserFile.objects.get(Username="Arthur_T"), RecipientUserFileID=UserFile.objects.get(Username="BobFitz"), EstimatedCompletionTimeUOM=" ", PriorityInQueue=3.0, InProcess=False, Completed=False, CreationDate=timezone.now())
        newStub10 = Stub(Title="Office Help", Overview="I need some assistance moving things in the office.", Category="Request", Urgency="When You Have Time", Domain="Office", IssuerUserFileID=UserFile.objects.get(Username="JasonM"), RecipientUserFileID=UserFile.objects.get(Username="BobFitz"), EstimatedCompletionTime="45", EstimatedCompletionTimeUOM="Minutes", PriorityInQueue=3.0, InProcess=False, Completed=False, CreationDate=timezone.now())
        newStub11 = Stub(Title="Special Part Pickup", Overview="Need to get a specific part from the supplier.", Category="Request", Urgency="Important", Domain="Supplier", IssuerUserFileID=UserFile.objects.get(Username="BobFitz"), RecipientUserFileID=UserFile.objects.get(Username="BrettNes"), EstimatedCompletionTime="30", EstimatedCompletionTimeUOM="Minutes", PriorityInQueue=1.0, InProcess=False, Completed=False, CreationDate=timezone.now())
        newStub12 = Stub(Title="Deliver Box Of Parts", Overview="Deliver these parts to the industrial sector.", Category="Request", Urgency="When You Have Time", Domain="Production", IssuerUserFileID=UserFile.objects.get(Username="JasonM"), RecipientUserFileID=UserFile.objects.get(Username="BobFitz"), EstimatedCompletionTime="2", EstimatedCompletionTimeUOM="Hours", PriorityInQueue=1.0, InProcess=False, Completed=False, CreationDate=timezone.now())
        newStub13 = Stub(Title="Access Issue", Overview="Change group policy to allow portal access.", Category="Request", Urgency="Important", Domain="IT", IssuerUserFileID=UserFile.objects.get(Username="KellyNichols"), RecipientUserFileID=UserFile.objects.get(Username="BobFitz"), EstimatedCompletionTime="2", EstimatedCompletionTimeUOM="Hours", PriorityInQueue=1.0, InProcess=False, Completed=False, CreationDate=timezone.now())
        newStub14 = Stub(Title="Network Connection", Overview="Users keep disconnecting from wifi.", Category="Issue", Urgency="Highly Important", Domain="IT", IssuerUserFileID=UserFile.objects.get(Username="JasonM"), RecipientUserFileID=UserFile.objects.get(Username="BobFitz"), EstimatedCompletionTime="2", EstimatedCompletionTimeUOM="Hours", PriorityInQueue=1.0, InProcess=False, Completed=False, CreationDate=timezone.now())
        ...
        newStub16 = Stub(Title="PC Set Up", Overview="Carol in accounting needs help with setting up her PC", Category="Request", Urgency="When You Have Time", Domain="Accounting", IssuerUserFileID=UserFile.objects.get(Username="JasonM"), RecipientUserFileID=UserFile.objects.get(Username="BobFitz"), EstimatedCompletionTime="2", EstimatedCompletionTimeUOM="Hours", PriorityInQueue=1.0, InProcess=False, Completed=False, CreationDate=timezone.now())
        newStub17 = Stub(Title="Apperance Of Profile", Overview="Can we change the look of the profile page to match the other pages.", Category="Upgrade", Urgency="Important", Domain="Development", IssuerUserFileID=UserFile.objects.get(Username="JasonM"), RecipientUserFileID=UserFile.objects.get(Username="BobFitz"), EstimatedCompletionTime="2", EstimatedCompletionTimeUOM="Hours", PriorityInQueue=1.0, InProcess=False, Completed=False, CreationDate=timezone.now())
        newStub18 = Stub(Title="Stub Attachments", Overview="Stub attachments are not saving the uploaded content.", Category="Bug", Urgency="Highly Important", Domain="Development", IssuerUserFileID=UserFile.objects.get(Username="Arthur_T"), RecipientUserFileID=UserFile.objects.get(Username="BobFitz"), EstimatedCompletionTime="2", EstimatedCompletionTimeUOM="Hours", PriorityInQueue=1.0, InProcess=False, Completed=False, CreationDate=timezone.now())
        ...
        newStub20 = Stub(Title="Photo Required", Overview="Need company photo.", Category="Request", Urgency="Important", Domain="Marketing", IssuerUserFileID=UserFile.objects.get(Username="JasonM"), RecipientUserFileID=UserFile.objects.get(Username="BobFitz"), EstimatedCompletionTime="2", EstimatedCompletionTimeUOM="Hours", PriorityInQueue=1.0, InProcess=False, Completed=False, CreationDate=timezone.now())
        newStub21 = Stub(Title="Additional Employee Details", Overview="Some minor information required for finance department.", Category="Request", Urgency="Somewhat Important", Domain="Finance", IssuerUserFileID=UserFile.objects.get(Username="JasonM"), RecipientUserFileID=UserFile.objects.get(Username="BobFitz"), EstimatedCompletionTime="2", EstimatedCompletionTimeUOM="Hours", PriorityInQueue=1.0, InProcess=False, Completed=False, CreationDate=timezone.now())
        newStub22 = Stub(Title="Enlarge Text", Overview="Can the text be enlarged on the home page?", Category="Suggestion", Urgency="Somewhat Important", Domain="Development", IssuerUserFileID=UserFile.objects.get(Username="JasonM"), RecipientUserFileID=UserFile.objects.get(Username="BobFitz"), EstimatedCompletionTime="2", EstimatedCompletionTimeUOM="Hours", PriorityInQueue=1.0, InProcess=False, Completed=False, CreationDate=timezone.now())
        newStub23 = Stub(Title="Stub Categories", Overview="Category choices should be set for users.", Category="Request", Urgency="Highly Important", Domain="Development", IssuerUserFileID=UserFile.objects.get(Username="Arthur_T"), RecipientUserFileID=UserFile.objects.get(Username="BobFitz"), EstimatedCompletionTime="2", EstimatedCompletionTimeUOM="Hours", PriorityInQueue=1.0, InProcess=False, Completed=False, CreationDate=timezone.now())
        newStub24 = Stub(Title="Peripheral Order", Overview="Need to order more peripherals for employees.", Category="Suggestion", Urgency="Important", Domain="IT", IssuerUserFileID=UserFile.objects.get(Username="Arthur_T"), RecipientUserFileID=UserFile.objects.get(Username="BobFitz"), EstimatedCompletionTime="2", EstimatedCompletionTimeUOM="Hours", PriorityInQueue=1.0, InProcess=False, Completed=False, CreationDate=timezone.now())
        newStub25 = Stub(Title="Company Quarterly Review", Overview="Need report on company quarterly earnings.", Category="Request", Urgency="Important", Domain="Accounting", IssuerUserFileID=UserFile.objects.get(Username="BrettNes"), RecipientUserFileID=UserFile.objects.get(Username="BobFitz"), EstimatedCompletionTime="2", EstimatedCompletionTimeUOM="Hours", PriorityInQueue=1.0, InProcess=False, Completed=False, CreationDate=timezone.now())
        newStub26 = Stub(Title="Job Application", Overview="Review job application for potential prospect.", Category="Request", Urgency="Highly Important", Domain="Human Resource", IssuerUserFileID=UserFile.objects.get(Username="Arthur_T"), RecipientUserFileID=UserFile.objects.get(Username="JasonM"), EstimatedCompletionTime="2", EstimatedCompletionTimeUOM="Hours", PriorityInQueue=1.0, InProcess=False, Completed=False, CreationDate=timezone.now())
        newStub27 = Stub(Title="Push Rod Failure", Overview="Warped push rods need replacing.", Category="Issue", Urgency="Immediate", Domain="Mechanical Engineering", IssuerUserFileID=UserFile.objects.get(Username="BobFitz"), RecipientUserFileID=UserFile.objects.get(Username="BrettNes"), EstimatedCompletionTime="2", EstimatedCompletionTimeUOM="Hours", PriorityInQueue=1.0, InProcess=False, Completed=False, CreationDate=timezone.now())
        newStub28 = Stub(Title="Blown Head Gasket", Overview="Replace head gasket.", Category="Bug", Urgency="Important", Domain="Mechanical Engineering", IssuerUserFileID=UserFile.objects.get(Username="BobFitz"), RecipientUserFileID=UserFile.objects.get(Username="JasonM"), EstimatedCompletionTime="2", EstimatedCompletionTimeUOM="Hours", PriorityInQueue=1.0, InProcess=False, Completed=False, CreationDate=timezone.now())
        newStub29 = Stub(Title="Update Client Information", Overview="Client information needs updating.", Category="Request", Urgency="Highly Important", Domain="Accounting", IssuerUserFileID=UserFile.objects.get(Username="BobFitz"), RecipientUserFileID=UserFile.objects.get(Username="Arthur_T"), EstimatedCompletionTime="2", EstimatedCompletionTimeUOM="Hours", PriorityInQueue=1.0, InProcess=False, Completed=False, CreationDate=timezone.now())
