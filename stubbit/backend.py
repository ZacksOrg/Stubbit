...
class Backend:
    ...
    def CreateTestStubs():
        ...
        newStub4 = Stub(Title="Rotary Girder Specs", Overview="Check the endline specs on the rotary girder.", Category="Sueggestion", Urgency="When You Have Time", Domain="Mechanical Engineering", IssuerUserFileID=UserFile.objects.get(Username="JasonM"), RecipientUserFileID=UserFile.objects.get(Username="BobFitz"), StartDate=timezone.now(), EstimatedCompletionTime="5", EstimatedCompletionTimeUOM="Minutes", PriorityInQueue=1.0, InProcess=False, Completed=False, CreationDate=timezone.now())
        ...
        newStub9 = Stub(Title="Product Line Failure", Overview="Line production has been halted from a failure.", Category="System Failure", Urgency="Immediate", Domain="Production", IssuerUserFileID=UserFile.objects.get(Username="BrettNes"), RecipientUserFileID=UserFile.objects.get(Username="BobFitz"), StartDate=timezone.now(), EstimatedCompletionTime="35", EstimatedCompletionTimeUOM="Minutes", PriorityInQueue=3.0, InProcess=False, Completed=False, CreationDate=timezone.now())
